    ...
    <div>
      <div className="flex-shrink-0 h-full p-5 w-[300px] bg-blue-500 rounded-xl">
        ...
        <div className="mt-4 flex justify-center">
          <button className="w-full px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-lg hover:bg-blue-600 transition duration-200 ease-in-out transform hover:scale-105">
            Accept Task
          </button>
        </div>
      </div>
